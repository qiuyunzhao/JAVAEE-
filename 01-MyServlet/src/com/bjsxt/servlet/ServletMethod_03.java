 ...
 *  * 		我们是不在覆写的service中调用父类的service方法的，如果调用父类的service方法而没用重写doPost和doGet方法，
 *  *       会出现405错误。
 *
 *  * Servlet的常见错误：
 *  * 		404错误:资源未找到
 ...
 * @Version: 1.0
 */
public class ServletMethod_03 extends HttpServlet {

    @Override
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("service()方法接受了请求");
//        super.service(req, resp);
    }

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("doPost()方法接受了请求");
    }

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("doGet()方法接受了请求");
    }
